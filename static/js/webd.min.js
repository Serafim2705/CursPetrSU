...
// Сохранение содержимого полей в sessionStorage
function saveFields() {
    var fieldsToSave = ['inp_year', 'inp_group', 'inp_department','inp_student','inp_adviser','group_method','sort_method','sort_order'];
  ...
  // Восстановление содержимого полей из sessionStorage
  function restoreFields() {
    var fieldsToRestore = ['inp_year', 'inp_group', 'inp_department','inp_student','inp_adviser','group_method','sort_method','sort_order'];
...
//    $("#webd_form").submit(search)
    document.querySelector('#start_table').scrollIntoView({ behavior: 'smooth' });
});